...
O RadioButton permite que seja escolhido um entre os que estão presentes.  
  
Ele recebe como parâmetros:

* Um contexto;  
* Um texto que serve como rótulo;  
* Uma variável que vai armazenar um valor indicado;  
